...
a persistence unit "wildflygestionPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "wildflygestion\pom.xml":
...
artifacts ("wildflygestion-ejb.jar" and "wildflygestion-web.war") are already built. You can build
